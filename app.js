(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.galvanised_jets = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
var alphabets = {
    ...
    "cyrillic": "абвгдеёжзийклмнопрстуфхцчшщъыьэюяґђѓєѕіїјљњћќўџ",
...
function lazyLoadWordlist(language, cb) {
...
exports.lazyLoadWordlist = lazyLoadWordlist;
/*
words:
...
var numeric = function () {
    ...
    wordDiv.empty();
    setSingleLine();
    wordDiv.append($(numeric_1.numeric_html));
};
...
},{"./numeric":4,"jquery":5}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const movingparts_1 = require("./movingparts");
const functions_1 = require("./functions");
const $ = require("jquery");
$(() => {
    movingparts_1.setupMovingParts();
    functions_1.setupFunctions();
    functions_1.lazyLoadWordlist("latin", () => {
        /* Start defaults */
        $("#btn_latin").click();
        $("#uppercase_pie").click();
        $("#hobonop input").click();
...
},{"./functions":1,"./movingparts":3,"jquery":5}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const $ = require("jquery");
function setupMovingParts() {
    /* Navbar toggles */
...
exports.setupMovingParts = setupMovingParts;
...
var numeric_html = `
        ...
        <h2><span>Lining Numerals</span></h2>
        <ul class="numeric lining">
            <li>1101010000 </li>
            <li>1111010100 </li>
            <li>1121010200 </li>
            <li>1131010300 </li>
        ...
        <h2><span>Tabular Numerals</span></h2>
        <ul class="numeric tabular">
            <li>1101010000 </li>
            <li>1111010100 </li>
            <li>1121010200 </li>
            <li>1131010300 </li>
        ...
        <h2><span>Numerators</span></h2>
        <ul class="numeric numerators">
            <li>HH0HH00000 </li>
            <li>HH1HH00100 </li>
            <li>HH2HH00200 </li>
            <li>HH3HH00300 </li>
        ...
        <h2><span>Denominators</span></h2>
        <ul class="numeric denominators">
            <li>HH0HH00000 </li>
            <li>HH1HH00100 </li>
            <li>HH2HH00200 </li>
            <li>HH3HH00300 </li>
        ...
        <h2><span>Assembled Fractions</span></h2>
        <ul class="numeric assembled">
            <li>HH½HH00½00 </li>
            <li>HH⅓HH00⅓00 </li>
            <li>HH⅔HH00⅔00 </li>
            <li>HH¼HH00¼00 </li>
        ...
        <h2><span>Fractions</span></h2>
        <ul class="numeric fractions">
            <li>HH1/2HH001/200<li>
            <li>HH1/3HH001/300<li>
            <li>HH2/3HH002/300<li>
            <li>HH1/4HH001/400<li>
            <li>HH3/4HH003/400<li>
            <li>HH1/5HH001/500<li>
            <li>HH2/5HH002/500<li>
            <li>HH3/5HH003/500<li>
            <li>HH4/5HH004/500<li>
            <li>HH1/6HH001/600<li>
            <li>HH5/6HH005/600<li>
            <li>HH1/8HH001/800<li>
            <li>HH3/8HH003/800<li>
            <li>HH5/8HH005/800<li>
            <li>HH7/8HH007/800<li>
        </ul>
        
        <h2><span>Latin Currency</span></h2>
        <ul class="numeric currency_latin">
            <li>HH¤HH00¤00 </li>
            <li>HH¢HH00¢00 </li>
            <li>HHcHH00c00 </li>
            <li>HH$HH00$00 </li>
        ...
        <h2><span>Cyrillic Currency</span></h2>
        <ul class="numeric currency_cyrillic">
            <li>HH₽HH00₽00 </li>
            <li>HH₴HH00₴00 </li>
            <li>HH₸HH00₸00 </li>
            <li>HH₮HH00₮00 </li>
        ...
        <h2><span>Other Currency</span></h2>
        <ul class="numeric currency_other">
            <li>HH₪HH00₪00 </li>
            <li>HH₺HH00₺00 </li>
            <li>HH﷼HH00﷼00 </li>
            <li>HHƒHH00ƒ00 </li>
        ...
        <h2><span>Old Style Numeral Grid</span></h2>
        <ul class="numeric grid old">
            <li>00 10 20 30 40 50 60 70 80 90 </li>
            <li>01 11 21 31 41 51 61 71 81 91 </li>
            <li>02 12 22 32 42 52 62 72 82 92 </li>
            <li>03 13 23 33 43 53 63 73 83 93 </li>
            <li>04 14 24 34 44 54 64 74 84 94 </li>
            <li>05 15 25 35 45 55 65 75 85 95 </li>
            <li>06 16 26 36 46 56 66 76 86 96 </li>
            <li>07 17 27 37 47 57 67 77 87 97 </li>
            <li>08 18 28 38 48 58 68 78 88 98 </li>
            <li>09 19 29 39 49 59 69 79 89 99 </li>
        </ul>
        
        <h2><span>Lining Numeral Grid</span></h2>
        <ul class="numeric grid lining">
            <li>00 10 20 30 40 50 60 70 80 90 </li>
            <li>01 11 21 31 41 51 61 71 81 91 </li>
            <li>02 12 22 32 42 52 62 72 82 92 </li>
            <li>03 13 23 33 43 53 63 73 83 93 </li>
        ...
        <h2><span>Tabular Numeral Grid</span></h2>
        <ul class="numeric grid tabular">
            <li>00 10 20 30 40 50 60 70 80 90 </li>
            <li>01 11 21 31 41 51 61 71 81 91 </li>
            <li>02 12 22 32 42 52 62 72 82 92 </li>
            <li>03 13 23 33 43 53 63 73 83 93 </li>
...
`;
exports.numeric_html = numeric_html;
